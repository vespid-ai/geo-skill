...
description: Use when the homepage is vague, slogan-heavy, or failing to define what the product is for AI search systems and first-time human visitors.
---

# GEO Homepage Positioning

Make the homepage define the product clearly with category, audience, problem, capabilities, and proof instead of vague brand copy.

## When to use

Use when the homepage is vague, slogan-heavy, or failing to define what the product is for AI search systems and first-time human visitors.
