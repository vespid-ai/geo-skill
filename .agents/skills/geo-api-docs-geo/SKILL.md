...
description: Use when the product exposes APIs or SDKs and the API documentation needs to become a first-class discovery and citation surface.
---

# GEO for API Docs

Improve API-doc GEO with endpoint-focused pages, authentication/setup clarity, examples, limits, and troubleshooting sections that match developer search intent.

## When to use

Use when the product exposes APIs or SDKs and the API documentation needs to become a first-class discovery and citation surface.
