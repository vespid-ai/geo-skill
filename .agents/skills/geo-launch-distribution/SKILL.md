...
description: Use when the site already has core pages but still needs external signals, distribution, and launch artifacts so AI systems can see more than the official site alone.
---

# GEO Launch and Distribution

Create external proof and distribution surfaces so GEO is supported by repo pages, social posts, directories, docs links, and third-party references.

## When to use

Use when the site already has core pages but still needs external signals, distribution, and launch artifacts so AI systems can see more than the official site alone.
