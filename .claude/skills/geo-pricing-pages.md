...
Use when pricing, free tier, or packaging questions are common and the site does not expose them cleanly enough for AI systems to answer.

## Goal

Make pricing pages machine-readable and direct so search agents can answer what it costs, what plans exist, and how usage is packaged.
