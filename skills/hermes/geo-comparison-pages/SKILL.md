...
description: Use when users compare your product to alternatives and you want AI systems to retrieve a grounded, balanced comparison page rather than random third-party summaries.
version: 0.1.0
author: vespid-ai
license: MIT
metadata:
...
Publish structured comparison pages that define differences, tradeoffs, target users, and capability boundaries without fake objectivity or keyword spam.

## Trigger

Use when users compare your product to alternatives and you want AI systems to retrieve a grounded, balanced comparison page rather than random third-party summaries.
