...
description: Use when the site needs stronger legitimacy, company identity, trust, and entity resolution signals for both AI systems and human evaluators.
version: 0.1.0
author: vespid-ai
license: MIT
metadata:
...
Expose trust pages and entity facts so AI systems can connect the product to a real team, company, policy surface, and contact identity.

## Trigger

Use when the site needs stronger legitimacy, company identity, trust, and entity resolution signals for both AI systems and human evaluators.
