...
description: Use when the product is docs-first or technical and you need the documentation set to become a primary GEO surface.
version: 0.1.0
author: vespid-ai
license: MIT
metadata:
...
# GEO Docs and Help Center

Turn docs and help-center content into a strong GEO surface with stable URLs, topic-focused pages, explicit examples, and internal linking.

## Trigger

Use when the product is docs-first or technical and you need the documentation set to become a primary GEO surface.
